...
function pickIngredientIconKey(name: string) {
  ...
  if (name.includes('열무김치')) return 'youngRadishKimchi'
  if (name.includes('튀김가루')) return 'fryingPowder'
  if (name.includes('시래기')) return 'siraegi'
  if (name.includes('계피')) return 'cinnamon'
  ...
  if (name.includes('요거트')) return 'greekYogurt'
  ...
  if (name.includes('콩국물')) return 'konggukmul'
  ...
  if (name.includes('케이크 시트')) return 'cakeSheet'
  if (name.includes('식빵')) return 'bread'
  ...
  if (name.includes('밀가루') || name.includes('부침가루')) return 'flour'
  ...
  if (name.includes('초당 옥수수') || name.includes('초당옥수수') || name.includes('옥수수')) return 'corn'
  ...
  if (name.includes('꽈리 고추') || name.includes('꽈리고추') || name.includes('고추')) return 'pepper'
  ...
  if (name.includes('간장')) return 'soySauce'
  if (name.includes('부침가루') || name.includes('밀가루')) return 'flour'
  if (name.includes('식용유') || name.includes('올리브오일')) return 'cookingOil'
